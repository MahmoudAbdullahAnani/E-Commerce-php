...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$fullName && !$age && !$date && !$userName && !$password) {
        ...
        if (count($notFound)===0) { 
            ...
            $user->insert('admin',$fullName,$age,$date,$password,$dateCreate,$userName,$gmail);
            $successfully = 'Account successfully created';
            sleep(2);
            header("location: /E-Commerce/admin.php?u=$userName");
            exit;
            $_POST['age']='';
            $_POST['date']='';
            $_POST['password']='';
    ...
    <main class="d-flex justify-content-center align-items-center" style="height: 100vh;">
        <div class=" border p-5 rounded-lg col-12 col-sm-6 col-md-4">
            ...
            <div class="text-center">
                <a href="./admin.php" class="link underline my-1">Login</a>
            </div>
        </div>
